...
export declare class ProveedoresController {
    private readonly proveedoresServies;
    constructor(proveedoresServies: ProveedoresServices);
    craete(createProveedorDto: CreateProveedoresDto): Promise<Proveedores>;
