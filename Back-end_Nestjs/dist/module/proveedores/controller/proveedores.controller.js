...
let ProveedoresController = class ProveedoresController {
    constructor(proveedoresServies) {
        this.proveedoresServies = proveedoresServies;
    }
    async craete(createProveedorDto) {
...
], ProveedoresController.prototype, "craete", null);
__decorate([
    (0, common_1.Put)('deactive/:id'),
    (0, swagger_1.ApiOperation)({ summary: 'Desctivar un proveedor' }),
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Actualizar de un proveedor' }),
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Actualizar de un proveedor parcialmente' }),
    (0, swagger_1.ApiResponse)({ status: 201, description: 'El proveedor ha sido actualizado' }),
    (0, swagger_1.ApiResponse)({ status: 400, description: 'No se encuentra el proveedor' }),
    (0, swagger_1.ApiResponse)({ status: 404, description: 'Solicitud incorrecta' }),
    (0, swagger_1.ApiBody)({
