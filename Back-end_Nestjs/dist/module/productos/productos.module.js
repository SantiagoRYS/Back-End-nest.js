...
const productos_controllers_1 = require("./controller/productos.controllers");
...
exports.ProductosModule = ProductosModule = __decorate([
    (0, common_1.Module)({
        imports: [mongoose_1.MongooseModule.forFeature([{ name: productos_schema_1.Productos.name, schema: productos_schema_1.ProductoSchema, }]),
